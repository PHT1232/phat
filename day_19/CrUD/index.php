...
<h3 style="color: red">
    <?php
    //nếu tồn tại session error, thì hiển thị, sau đó xóa luôn
    //này, để đảm bảo session chỉ tồn tại 1 lần duy nhất
...
<table border="1" cellpadding="8" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            <?php echo date('d-m-Y H:i:e', strtotime($student['created_at'])); ?>
        </td>
        <td>
            <a href="detail.php?id=<?php echo $student['id']; ?>">Chi tiết</a>
            <a href="update.php?id=<?php echo $student['id']; ?>">Cập nhập</a>
            <a href="delete.php?id=<?php echo $student['id']; ?>" onclick="return confirm('do you really want to delete?')">Xóa</a>
        </td>
    </tr>
    <?php endforeach; ?>
    <?php endif; ?>
